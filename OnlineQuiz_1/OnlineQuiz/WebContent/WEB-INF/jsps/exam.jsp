<%@ page language="java" import="com.quiz.*" contentType="text/html; charset=ISO-8859-1"
...
<%
 ...
 %>
Cur"WebContent/WEB-INF/jsps/home.jsp"rent Question ${sessionScope.quest.questionNumber+1} / 10
</div>
