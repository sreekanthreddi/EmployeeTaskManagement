...
<title>ETMS - Project Remove Page</title>
<script>
	$(function() {
		$("#btnYes").button();
		$("#btnNo").button();
...
<body style="background-color:#007399">
	...
	<div id="resultDiv">
		Project removed successfully. <br />
	...
	%>
	<form method='post'
		action='/EmployeeTaskManagement/ProjectProcess?Service=removePrj&PrjId=
		<%=projectId%>'>
		<div>
			Are you sure you want to remove project with id
			<%=projectId%>
			? <br />
